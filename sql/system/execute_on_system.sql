...
-- Safely drop all user tables (excluding LogMiner/system ones)
BEGIN
  FOR t IN (
    SELECT table_name
    FROM user_tables
...
/
------------------------------------------------------------
-- DIRECTORY SETUP FOR CSV FILES
------------------------------------------------------------

BEGIN
  EXECUTE IMMEDIATE 'DROP DIRECTORY DANE1';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/

CREATE DIRECTORY DANE1 AS '/opt/oracle/dane';
GRANT READ, WRITE ON DIRECTORY DANE1 TO PUBLIC;
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Kontynenty CASCADE CONSTRAINTS PURGE';
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Kraje CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Miasta CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Hotele CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Klienci CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Pracownicy CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Przewodnicy CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Wycieczki CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Oceny CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Ubezpieczenia CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Rezerwacje CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Rezerwacje_Ubezpieczen CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Transport CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Etapy_Transportu CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Przesiadki CASCADE CONSTRAINTS PURGE';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
